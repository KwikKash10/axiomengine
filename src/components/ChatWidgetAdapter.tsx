          ...
          <div className="flex-1 flex flex-col p-4">
            <div className="text-center py-8">
              ...
              <div className="space-y-4">
                <button className="w-full py-3 px-4 bg-[#282958] text-white rounded-lg hover:bg-opacity-90 transition-all">
                  Contact Support
                </button>
                <button className="w-full py-3 px-4 bg-gray-100 text-gray-800 rounded-lg hover:bg-gray-200 transition-all">
                  View FAQs
                </button>
              </div>
            </div>
