...
export default async function handler(req, res) {
  ...
  try {
        ...
        lineItems = [
          {
            price_data: {
              ...
              product: productIds[sanitizedPlanType],
    ...
    // Product information
    const productName = sanitizedPlanType === 'lifetime' ? 'Lifetime Premium Access' : 
                        sanitizedPlanType === 'yearly' ? 'Annual Premium Membership' : 
    ...
    const baseSessionParams = {
      ...
      payment_intent_data: mode === 'payment' ? {
        description: `${productName} - Getino Premium`,
