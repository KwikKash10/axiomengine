  ...
  useEffect(() => {
    const detectUserCurrency = async () => {
      ...
      try {
        ...
        if (savedCurrency) {
          // Verify it's a valid currency code we support
        ...
        try {
          // First attempt: IP-based geolocation with timeout
          ...
          if (response.ok) {
            ...
            if (countryCode && COUNTRY_TO_CURRENCY[countryCode]) {
              ...
              console.log('Currency set from IP geolocation:', detectedCurrency);
              return;
            }
          }
        } catch (fetchError) {
          console.log('IP geolocation failed, using fallback:', fetchError);
          // Continue to fallback approach
        }
        
        // Fallback: Browser locale
        const browserLocale = navigator.language;
        console.log('Falling back to browser locale:', browserLocale);
        ...
        if (browserLocale.startsWith('en-US')) detectedCurrency = 'USD';
                ...
                browserLocale.startsWith('es')) detectedCurrency = 'EUR';
        ...
        setUserCurrency('USD'); // Default to USD if all methods fail
      } finally {
        setIsDetectingCurrency(false);
      }
    };
              ...
              <div className="w-full md:flex-[0.63]">
                ...
                <div className="rounded-lg bg-transparent p-3 mt-3">
                  ...
                  <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4">
                    <img src="/secure payment methods/visa.svg" alt="Visa" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/mastercard.svg" alt="Mastercard" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/maestro.svg" alt="Maestro" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/amex.svg" alt="American Express" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/discover.svg" alt="Discover" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/diners.svg" alt="Diners Club" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/cartes-bancaires.svg" alt="Cartes Bancaires" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/apple-pay.svg" alt="Apple Pay" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                    <img src="/secure payment methods/google-pay.svg" alt="Google Pay" className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" />
                  </div>
