...
export default function CheckoutPage() {
  ...
  // Add state and ref for payment methods animation
  ...
  // Currency and exchange rates are handled by useEffects defined later in this component

  // Setup intersection observer for payment methods section
  useEffect(() => {
    ...
    return () => {
      if (paymentMethodsRef.current) {
        observer.unobserve(paymentMethodsRef.current);
      }
    };
  }, []);
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:flex-[0.63]">
                ...
                <div className="rounded-lg bg-transparent p-3 mt-3" ref={paymentMethodsRef}>
                  <h3 className="text-lg font-semibold text-[#374151] mb-4 text-center">
                    Secure Payment Methods
                  </h3>
                  <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4">
                    <img 
                      src="/secure payment methods/visa.svg" 
                      alt="Visa" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-right' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.1s' }} 
                    />
                    <img 
                      src="/secure payment methods/mastercard.svg" 
                      alt="Mastercard" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-right' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.3s' }} 
                    />
                    <img 
                      src="/secure payment methods/maestro.svg" 
                      alt="Maestro" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-right' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.5s' }} 
                    />
                    <img 
                      src="/secure payment methods/amex.svg" 
                      alt="American Express" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-right' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.7s' }} 
                    />
                    <img 
                      src="/secure payment methods/discover.svg" 
                      alt="Discover" 
                      className="h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1" 
                    />
                    <img 
                      src="/secure payment methods/diners.svg" 
                      alt="Diners Club" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-left' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.7s' }} 
                    />
                    <img 
                      src="/secure payment methods/cartes-bancaires.svg" 
                      alt="Cartes Bancaires" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-left' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.5s' }} 
                    />
                    <img 
                      src="/secure payment methods/apple-pay.svg" 
                      alt="Apple Pay" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-left' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.3s' }} 
                    />
                    <img 
                      src="/secure payment methods/google-pay.svg" 
                      alt="Google Pay" 
                      className={`h-6 sm:h-8 rounded-md transition-all duration-200 hover:scale-110 hover:shadow-md my-1 ${isPaymentSectionVisible ? 'animate-slide-in-left' : 'opacity-0'}`} 
                      style={{ animationDelay: '0.1s' }} 
                    />
